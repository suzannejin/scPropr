...
parser$add_argument('--method', type='character', nargs='+', help="Transformation method(s) used")
...
if ( length(parser$transformed) != length(parser$method) || length(parser$method) != length(parser$refgene) ) stop("please make sure you give the correct inputs")
